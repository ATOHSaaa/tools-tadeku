(function () {
  ...
  const PANEL_HTML = `
<div class="note-style-ui">
  <div class="panel" id="panel" role="dialog" aria-label="Note Style">
    <div class="wrap ui-root" id="ui-root" data-enabled="true">
      <div class="header">
        <div class="title">Note Style</div>
  ...
  <button type="button" class="fab" id="fab" aria-label="Note Style" aria-expanded="false" title="Note Style">Nt</button>
</div>`;
